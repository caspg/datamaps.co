    ...
    return (
      <div className={style.container}>
        <form action={url} method="POST">
          ...
          <textarea name="message" id="message" className={style.textarea} type="text" required="required" placeholder="message" />

          <label htmlFor="contact-email">Your contact email:</label>
          <input name="email" id="contact-email" className={style.input} type="text" type="email" placeholder="email" name="_replyto" />
